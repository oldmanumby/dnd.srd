...
This section presents the Warlock spell list. The spells are organised by spell level and then alphabetised, and each spell's school of magic is listed. In the Special column, C means the spell requires Concentration, R means it's a Ritual, and M means it requires a specific Material component.
